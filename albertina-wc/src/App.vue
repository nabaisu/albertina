    ...
    <div v-if="Boolean(chosenRecipe) === false" class>
      ...
      <div class="d-flex flex-wrap flex-row justify-content-center">
        ...
        >
          <img
            class="card-img-top"
            :src="recipe.image || imagemAlbertina"
            style="height: 10rem;"
            alt="Card image cap"
          />
          <div class="card-body">
...
const recipeData = [
  {
    ...
    "@type": "Recipe",
    name: "Massa para pies e mais qualquer coisa que eu queira meter asqui",
    image: "",
    description:
      "isto \u00e9 uma descri\u00e7\u00e3o fant\u00e1stica. basicamente.",
    keywords: "",
    author: { "@type": "Person", name: "" },
    prepTime: "10 mins",
    cookTime: "",
    totalTime: "10 mins",
    recipeCategory: "pronto, agora voau ",
    ...
    recipeIngredient: [
      ...
      "1 pitada de sal",
      "100g de gordura",
      "Cerca de 7 colheres de ch\u00e1 de \u00e1gua fria"
    ],
    recipeInstructions: [
      {
        "@type": "HowToStep",
        text: "Peneira-se a farinha com o sal para 1 tigela grande."
      },
      {
        "@type": "HowToStep",
        text:
          "Com as pontas dos dedos, mistura-se bem a farinha com a gordura, durante 2 - 3 minutos, at\u00e9 ficar com o aspecto da areia."
      },
      {
        "@type": "HowToStep",
        text:
          "Junta-se a \u00e1gua e com 1 faca de ponta redonda, mistura-se bem at\u00e9 a massa come\u00e7ar a ficar pegajosa."
      },
      {
        "@type": "HowToStep",
        text:
          "Trabalha-se bem com a m\u00e3o, durante alguns segundos, at\u00e9 ficar uniforme e macia."
      },
      {
        "@type": "HowToStep",
        text:
          "Envolve-se em papel manteiga e deixa-se descansar no frigor\u00edfico durante cerca de 15 minutos, ou envolve-se em pel\u00edcula aderente e leva-se ao frigor\u00edfico durante 2 dias."
      },
      {
        "@type": "HowToStep",
        text:
          "Estende-se a massa sobre superf\u00edcie polvilhada e corta-se segundo a receita."
      },
      { "@type": "HowToStep", text: "Forno regulado no 6 ou no 7 (#traduzir)" }
    ]
  },
  {
    "@context": "https://schema.org/",
    "@type": "Recipe",
    name: "Massa para pizzas",
    image: "https://cataas.com/cat",
    description: "desta \u00e9 que eu n\u00e3o me vou safar basicamente",
    keywords: "",
    author: { "@type": "Person", name: "Albertina" },
    prepTime: "",
    cookTime: "",
    totalTime: "",
    ...
    recipeInstructions: [
      ...
      {
        "@type": "HowToStep",
        text: "Corta-se a gordura em bocadinhos e junta-se \u00e0 farinha."
      },
      {
        "@type": "HowToStep",
        text:
